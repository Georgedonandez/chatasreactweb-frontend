                ...
                <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                            <li><a class="dropdown-item" href="/#portfolio">Productos</a></li>
                            <li><a class="dropdown-item" href="/#noticias">Noticias</a></li>
                            <li><a class="dropdown-item" href="/#about">Quiénes Somos</a></li>
                            <li><hr class="dropdown-divider" /></li>
                            <li><a class="dropdown-item" href="/#contact2">Contáctanos</a></li>
                        </ul>
                    </div>
                </div>
